...
//--------------------------
    ...
    $("#item-info").on(showEvent, function(evt){
        ...
        //debugger;
        if (evt.target && (evt.target.id === "all-info")){ //bug: relys on "show all info" button to be 'shown', need to listen for the shown div 'item-info' to complete loading/replacing
